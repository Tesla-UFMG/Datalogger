...
void readSD(void) {
    // fazer um f_lseek, dps um fgets ou um f_read, colocar num buffer e escolher a
    // posição do hodometro
    ...
    if (aux > 0) {
        ...
        fresult = f_open(&file1, bufferFile,
                         FA_OPEN_ALWAYS | FA_READ); // open file on SD card to write*/
...
void Cabecalho(void) {
    ...
    char cabecalho[1625];
    strcpy(cabecalho,
           "TIMER\tVOL\tACELERADOR\tFREIO\tMODO\tFRENAGEM_REG\tHODOMETRO_P\tHODOMETRO_"
           "T\tTORQUE_R\tTORQUE_L\tTORQUE_REF_R_\tTORQUE_REF_L\tSPEED_R_MOTOR\tSPEED_L_"
           "MOTOR\tECU_CONTROL_ID\tECU_CONTROL_EVENT_ID\tSPEED_FRONT_L_TIE\tSPEED_FRONT_"
           "R_TIE\tSPEED_BACK_R_TIE\tSPEED_BACK_L_TIE\tTORQUE_GAIN\tSENTIDO_VOL\tCORR_"
           "TORQUE_R\tCORR_TORQUE_L\tTEMP_INV_1_R\tTEMP_INV_2_R\tTEMP_INV_1_L\tTEMP_INV_"
           "2_L\tSPEED_L\tSPEED_R\tPOWER_L\tPOWER_R\tENERGY_L\tENERGY_R\tOVERLOAD_"
           "L\tOVERLOAD_R\tLOST_MSG_L\tLOST_MSG_R\tBUS_OFF_L\tBUS_OFF_R\tCAN_STATE_"
           "L\tCAN_STATE_R\tINV_STATE_L\tINV_STATE_R\tFALHA_L\tFALHA_R\tALARM_L\tALARM_"
           "R\tACCEL_X\tACCEL_Y\tACCEL_Z\tERRO\tGYRO_X\tGYRO_Y\tGYRO_Z\tERROR\tV_MAX\tV_"
           "MIN\tDELTA_V\tTEMP_MAX\tMODO_BMS\tBMS_ERROR_FLAG\tCONTATORES_STATUS\tV_TS\tI_"
           "SENSOR_1_ALTA\tI_SENSOR_2_BAIXA\tI_SENSOR_2_ALTA\tI_SENSOR_3_BAIXA\tI_SENSOR_"
           "3_ALTA\tI_SENSOR_4_BAIXA\tI_SENSOR_4_"
           "ALTA\tVCel101\tVCel102\tVCel103\tVCel104\tVCel105\tVCel106\tVCel107\tVCel108"
           "\tVCel109\tVCel110\tVCel111\tVCel112\tTemp101\tTemp102\tTemp103\tTemp104\tTem"
           "p105\tV_TOT_1\tV_REF_1\tFLAG_BAL_"
           "1\tVCel201\tVCel102\tVCel203\tVCel204\tVCel205\tVCel206\tVCel207\tVCel208\tVC"
           "el209\tVCel211\tVCel212\tTemp201\tTemp202\tTemp203\tTemp204\tTemp205\tV_TOT_"
           "2\tV_REF_2\tFLAG_BAL_"
           "2V\tVCel301\tVCel302\tVCel303\tVCel304\tVCel305\tVCel306\tVCel307\tVCel308\tV"
...
//
//		fresult = f_open(&file, bufferFile, FA_OPEN_ALWAYS | FA_WRITE); //open file
//on SD card to write*/ 		fresult = f_lseek(&file, 0); //goes to beginning of the file (n
//sei se precisa) 		fresult = f_write(&file, condicoes, len, &bytes_written);//write data to
//the file 		fresult = f_close(&file);//closes the file
//
//		if(fresult == FR_OK){
//			_datalog_flag  = 1;
//		}
